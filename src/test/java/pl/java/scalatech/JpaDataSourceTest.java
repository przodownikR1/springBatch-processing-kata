...
public class JpaDataSourceTest {
    ...
    public void shouldPersistAirport() {
        ...
        Airport airport = Airport.builder().id(679l).airPortName("Okecie").city("Warsaw").country("Poland").shortcut("WAW").arName("EPWA")
                .lat(BigDecimal.valueOf(52.16575)).lon(BigDecimal.valueOf(20.967122)).alt(BigDecimal.valueOf(362)).port(1).sk("E").region("Europe/Warsaw")
                .build();

package pl.java.scalatech.dummy;
...
@ContextConfiguration(locations = { "classpath:readWriteDummy.xml" })
@ActiveProfiles(value = { "test" })
@Slf4j
public class ReadWriteJobTest {
    @Autowired
    ...
    public void shouldReadWrite() throws SQLException {
        ...
        try {
            ...
            params.put("output.file", new JobParameter("file:outgoing/PassThroughField.csv"));
            JobExecution execution = jobLauncher.run(readWriteJob, new JobParameters(params));

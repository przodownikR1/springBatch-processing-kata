...
@ContextConfiguration(locations = { "classpath:repositoryTest.xml" })
...
public class DataReadWriteTest {
    ...
    @Autowired
    private Job jpaDataReadWriteJob;
    @Autowired
    ...
    public void shouldReadWrite() throws SQLException {
        ...
        try {
            ...
            JobExecution execution = jobLauncher.run(jpaDataReadWriteJob, new JobParameters(params));
